...
# RankingContinuous
    ...
    formatted_data = {
        'significant_KPIVs': {
            ...
            'nSignificantError': RankingContinuous['nSignificantError'],
    ...
    nSignificantError = formatted_data['significant_KPIVs']['nSignificantError']
    ...
    return data_frame,nSignificant,rankingErrorAverage,reliability,data_frame_2,nSignificant_2,rankingErrorAverage_2,reliability_2,nSignificantError
...
def get_ranking(model, line, start, end, selecteKPOV, selecteKPIV):
    ...
    print("******************************************result = Bin_Auto(model, selecteKPOV)******************",result,"********************************")
    ...
    data_frame, nSignificant, rankingErrorAverage, reliability, data_frame_2, nSignificant_2, rankingErrorAverage_2, reliability_2 ,nSignificantError= result_tuple
    ...
    print("nSignificantError", nSignificantError)
    print("rankingErrorAverage", rankingErrorAverage)
    print("reliability", reliability)
    
    
    formatted_ranking_error_average = round(rankingErrorAverage, 3)
    
    return jsonify({
                    # Continuous KPIVs
                    'result_dict_1': result_dict, 
                    "nSignificant": nSignificant,"rankingErrorAverage": formatted_ranking_error_average,"reliability":reliability,
                    "nSignificantError":nSignificantError,
                    # Categorical KPIVs
